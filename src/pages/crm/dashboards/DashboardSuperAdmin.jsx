...
// Panels
import SuperAdminStats from '../panelssuperadmin/SuperAdminStats';
...
import ModuleConfigPanel from '../panelssuperadmin/ModuleConfigPanel';
import EnterpriseGroupPanel from '../panelssuperadmin/EnterpriseGroupPanel';
import SuperAdminPersonnel from '../panelssuperadmin/SuperAdminPersonnel';
import SuperAdminAgenda from '../panelssuperadmin/SuperAdminAgenda';
import ChatbotConfigPanel from '../panelssuperadmin/ChatbotConfigPanel';

const DashboardSuperAdmin = ({ enabledModules }) => {
  ...
  return (
    <DashboardShell
      ...
      stats={stats}
    >
      {activeTab === 'dashboard' && <SuperAdminStats setActiveTab={setActiveTab} />}
      ...
      {activeTab === 'module-config' && <ModuleConfigPanel />}
      {activeTab === 'enterprise-group' && <EnterpriseGroupPanel />}
      {activeTab === 'personnel' && <SuperAdminPersonnel />}
      {activeTab === 'agenda' && <SuperAdminAgenda />}
      {activeTab === 'chatbot-config' && <ChatbotConfigPanel />}
